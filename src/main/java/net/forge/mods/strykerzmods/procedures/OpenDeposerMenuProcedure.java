...
import net.forge.mods.strykerzmods.gui.GuiAtmDeposerGui;
...
public class OpenDeposerMenuProcedure extends StrykerzmodsModElements.ModElement {
	public OpenDeposerMenuProcedure(StrykerzmodsModElements instance) {
		super(instance, 30);
	}
			...
			if (_ent instanceof ServerPlayerEntity) {
				...
				NetworkHooks.openGui((ServerPlayerEntity) _ent, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("GuiAtmDeposer");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new GuiAtmDeposerGui.GuiContainerMod(id, inventory, new PacketBuffer(Unpooled.buffer()).writeBlockPos(_bpos));
					}
				}, _bpos);
			}
		}
