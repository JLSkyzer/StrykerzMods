...
public class Retirer200Procedure extends StrykerzmodsModElements.ModElement {
	public Retirer200Procedure(StrykerzmodsModElements instance) {
		super(instance, 27);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((entity.getCapability(StrykerzmodsModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (entity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(Billet200Item.block, (int) (1));
