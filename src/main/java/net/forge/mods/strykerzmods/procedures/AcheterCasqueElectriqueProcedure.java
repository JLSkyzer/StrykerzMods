...
import net.forge.mods.strykerzmods.item.Electric_armorArmorItem;
...
public class AcheterCasqueElectriqueProcedure extends StrykerzmodsModElements.ModElement {
	public AcheterCasqueElectriqueProcedure(StrykerzmodsModElements instance) {
		super(instance, 53);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure AcheterCasqueElectrique!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure AcheterCasqueElectrique!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure AcheterCasqueElectrique!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure AcheterCasqueElectrique!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure AcheterCasqueElectrique!");
			return;
		}
		...
		if ((((entity.getCapability(StrykerzmodsModVariables.PLAYER_VARIABLES_CAPABILITY, null)
			...
			if (entity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(Electric_armorArmorItem.helmet, (int) (1));
				_setstack.setCount((int) 1);
				ItemHandlerHelper.giveItemToPlayer(((PlayerEntity) entity), _setstack);
			}
			{
				String _setval = (String) "\u00A74-500 $ \u00A7bCasque Electrique \u00A7esur \u00A76CMinecount";
				entity.getCapability(StrykerzmodsModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
