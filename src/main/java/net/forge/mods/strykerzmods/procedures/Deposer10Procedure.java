...
public class Deposer10Procedure extends StrykerzmodsModElements.ModElement {
	public Deposer10Procedure(StrykerzmodsModElements instance) {
		super(instance, 32);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure Deposer10!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if (((entity instanceof PlayerEntity)
				? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(Billet10Item.block, (int) (1)))
				: false)) {
			if (entity instanceof PlayerEntity)
				((PlayerEntity) entity).inventory.clearMatchingItems(p -> new ItemStack(Billet10Item.block, (int) (1)).getItem() == p.getItem(),
						(int) 1);
			{
