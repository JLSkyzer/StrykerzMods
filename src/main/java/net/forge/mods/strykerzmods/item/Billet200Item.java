...
public class Billet200Item extends StrykerzmodsModElements.ModElement {
	@ObjectHolder("strykerzmods:billet_200")
	public static final Item block = null;
	public Billet200Item(StrykerzmodsModElements instance) {
		super(instance, 16);
	}
