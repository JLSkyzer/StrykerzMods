...
public class Ak47Item extends StrykerzmodsModElements.ModElement {
	@ObjectHolder("strykerzmods:ak_47")
	public static final Item block = null;
	@ObjectHolder("strykerzmods:entitybulletak_47")
	public static final EntityType arrow = null;
	public Ak47Item(StrykerzmodsModElements instance) {
		super(instance, 58);
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(GunTabItemGroup.tab).maxStackSize(1));
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 3f, 5, 0);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(BulletTextureItem.block, (int) (1));
		}
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("strykerzmods:ak47-soundbible.com")),
