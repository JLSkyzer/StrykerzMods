...
public class Billet500Item extends StrykerzmodsModElements.ModElement {
	@ObjectHolder("strykerzmods:billet_500")
	public static final Item block = null;
	public Billet500Item(StrykerzmodsModElements instance) {
		super(instance, 17);
	}
