...
public class BulletItem extends StrykerzmodsModElements.ModElement {
	@ObjectHolder("strykerzmods:bullet")
	public static final Item block = null;
	public BulletItem(StrykerzmodsModElements instance) {
		super(instance, 55);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(GunTabItemGroup.tab).maxStackSize(30));
