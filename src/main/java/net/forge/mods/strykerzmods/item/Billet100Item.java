...
public class Billet100Item extends StrykerzmodsModElements.ModElement {
	@ObjectHolder("strykerzmods:billet_100")
	public static final Item block = null;
	public Billet100Item(StrykerzmodsModElements instance) {
		super(instance, 15);
	}
