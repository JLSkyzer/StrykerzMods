...
import net.forge.mods.strykerzmods.procedures.OpenMinerShopProcedure;
import net.forge.mods.strykerzmods.procedures.OpenMarketProcedure;
import net.forge.mods.strykerzmods.procedures.OpenBanqueProcedure;
...
public class GuiPhoneGui extends StrykerzmodsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public GuiPhoneGui(StrykerzmodsModElements instance) {
		super(instance, 49);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("gui_phone"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("strykerzmods:textures/gui_phone.png");
		@Override
		...
		if (buttonID == 0) {
			{
				...
				OpenMarketProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				OpenBanqueProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				OpenMinerShopProcedure.executeProcedure($_dependencies);
			}
		}
	}
