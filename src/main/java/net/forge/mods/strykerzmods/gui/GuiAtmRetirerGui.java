...
import net.forge.mods.strykerzmods.procedures.Retirer5Procedure;
import net.forge.mods.strykerzmods.procedures.Retirer50Procedure;
import net.forge.mods.strykerzmods.procedures.Retirer500Procedure;
import net.forge.mods.strykerzmods.procedures.Retirer20Procedure;
import net.forge.mods.strykerzmods.procedures.Retirer200Procedure;
import net.forge.mods.strykerzmods.procedures.Retirer10Procedure;
import net.forge.mods.strykerzmods.procedures.Retirer100Procedure;
...
public class GuiAtmRetirerGui extends StrykerzmodsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public GuiAtmRetirerGui(StrykerzmodsModElements instance) {
		super(instance, 20);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("gui_atm_retirer"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("strykerzmods:textures/gui_atm_retirer.png");
		@Override
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + -83, this.guiTop + 11, 80, 20, "Retour", e -> {
		...
		if (buttonID == 0) {
			{
				...
				Retirer5Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Retirer10Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Retirer20Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 3) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Retirer50Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 4) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Retirer100Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 5) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Retirer200Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 6) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Retirer500Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 7) {
			{
