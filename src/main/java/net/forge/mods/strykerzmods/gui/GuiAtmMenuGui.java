...
import net.forge.mods.strykerzmods.procedures.OpenRetirerMenuProcedure;
import net.forge.mods.strykerzmods.procedures.OpenDeposerMenuProcedure;
...
public class GuiAtmMenuGui extends StrykerzmodsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public GuiAtmMenuGui(StrykerzmodsModElements instance) {
		super(instance, 19);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("gui_atm_menu"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("strykerzmods:textures/gui_atm_menu.png");
		@Override
		...
		if (buttonID == 0) {
			{
				...
				OpenRetirerMenuProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				OpenDeposerMenuProcedure.executeProcedure($_dependencies);
			}
		}
	}
