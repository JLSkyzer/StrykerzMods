...
import net.forge.mods.strykerzmods.procedures.Deposer5Procedure;
import net.forge.mods.strykerzmods.procedures.Deposer50Procedure;
import net.forge.mods.strykerzmods.procedures.Deposer500Procedure;
import net.forge.mods.strykerzmods.procedures.Deposer20Procedure;
import net.forge.mods.strykerzmods.procedures.Deposer200Procedure;
import net.forge.mods.strykerzmods.procedures.Deposer10Procedure;
import net.forge.mods.strykerzmods.procedures.Deposer100Procedure;
import net.forge.mods.strykerzmods.procedures.AtmRetourProcedure;
...
public class GuiAtmDeposerGui extends StrykerzmodsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public GuiAtmDeposerGui(StrykerzmodsModElements instance) {
		super(instance, 29);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("gui_atm_deposer"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("strykerzmods:textures/gui_atm_deposer.png");
		@Override
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + -65, this.guiTop + 11, 60, 20, "Retour", e -> {
		...
		if (buttonID == 0) {
			{
				...
				Deposer5Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Deposer10Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Deposer20Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 3) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Deposer50Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 4) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Deposer100Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 5) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Deposer200Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 6) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				Deposer500Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 7) {
			{
				...
				AtmRetourProcedure.executeProcedure($_dependencies);
			}
		}
	}
