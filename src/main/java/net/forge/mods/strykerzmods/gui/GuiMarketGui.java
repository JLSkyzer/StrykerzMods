...
import net.forge.mods.strykerzmods.procedures.AcheterCasqueElectriqueProcedure;
import net.forge.mods.strykerzmods.procedures.AcheterAk47Procedure;
...
public class GuiMarketGui extends StrykerzmodsModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public GuiMarketGui(StrykerzmodsModElements instance) {
		super(instance, 51);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("gui_market"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("strykerzmods:textures/gui_market.png");
		@Override
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 38, this.guiTop + 32, 207, 20, "Acheter §bCasque electrique pour §a500$", e -> {
				StrykerzmodsMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
				handleButtonAction(entity, 0, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 18, this.guiTop + -21, 210, 20, "Quitter L'application", e -> {
				StrykerzmodsMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(1, x, y, z));
				handleButtonAction(entity, 1, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 38, this.guiTop + 77, 208, 20, "Acheter §bAK47 §f+ §b6 munition §a12.000$", e -> {
		...
		if (buttonID == 0) {
			{
				...
				AcheterCasqueElectriqueProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
		...
		if (buttonID == 2) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				AcheterAk47Procedure.executeProcedure($_dependencies);
			}
		}
	}
